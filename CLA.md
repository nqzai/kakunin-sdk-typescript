...
Your present and future Contributions submitted to Kakunin. Except for the
licenses granted here, You retain all right, title, and interest in and to
Your Contributions.

## 1. Definitions

- **"You"** (or **"Your"**) means the individual who submits a Contribution,
  or the legal entity authorizing this Agreement. For a legal entity, the
  entity and all entities that control it, are controlled by it, or are under
  common control with it are considered a single Contributor.
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to an existing work, that You intentionally
  submit to Kakunin for inclusion in, or documentation of, any of the
  projects we manage (the "Work"). "Submit" means any form of electronic,
  verbal, or written communication sent to Kakunin or its representatives,
  including but not limited to pull requests, issues, and code review
  comments, but excluding communication conspicuously marked or otherwise
  designated in writing by You as "Not a Contribution".

## 2. Grant of Copyright License

Subject to the terms of this Agreement, You grant to Kakunin and to recipients
of software distributed by Kakunin a perpetual, worldwide, non-exclusive,
...
1. You are legally entitled to grant the above licenses. If Your employer(s)
   ...
   such rights for Your Contributions to Kakunin, or that Your employer has
   executed a separate Corporate CLA with Kakunin.
...
submit it to Kakunin separately from any Contribution, identifying the
...
You agree to notify Kakunin of any facts or circumstances of which You become
aware that would make the representations in this Agreement inaccurate in any
respect.

---

**How to sign:** Sign electronically by posting the following comment on your
pull request, exactly as written:

> I have read the CLA Document and I hereby sign the CLA

Your GitHub username, the signing timestamp, and the commit are recorded in
`signatures/version1/cla.json` in this repository.
